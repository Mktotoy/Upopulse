 ...
 */
public class CreateAccount extends ActionBarActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener
{
    // TOOLBAR ATTRIBUTES \\
    ...
    String lat, lon;// Declaring Action Bar Drawer Toggle
     ...
     */
        ...
        final GestureDetector mGestureDetector = new GestureDetector(CreateAccount.this, new GestureDetector.SimpleOnGestureListener() {
        ...
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                {
                    if (pwd.getText().toString().equals(pwd1.getText().toString()) == false || pwd.getText().toString().equals("") == true)
                    {
                        TextView infopass = (TextView) findViewById(R.id.infopass);
    ...
    public void createDialogPartageLoc(final String code){
        ...
        LayoutInflater inflater = CreateAccount.this.getLayoutInflater();
    ...
    class UserLocationRequest  extends AsyncTask<Void, Void, Void> {
        ...
        private ProgressDialog dialog = new ProgressDialog(CreateAccount.this);
        String error;
    ...
    class RequestItemsServiceTask extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... unused) {
            ...
            try
            {
                error = r.createUser(name.getText().toString(), firstname.getText().toString(), email.getText().toString(), pwd.getText().toString(), description.getText().toString());
            }
            catch (Throwable e)
            {
                // handle exceptions
        ...
        protected void onPostExecute(Void unused)
        {
            ...
            {
                TextView infopass = (TextView) findViewById(R.id.infopass);
                infopass.setText("Votre compte a bien été créé");
            }
        }
    }
}
